...
import { Character, Category } from "@prisma/client";
...
const formSchema = z.object({
    ...
    instructions: z.string().min(200, {
        message: "Instruction is requried >= 200 characters.",
    }),
    seed: z.string().min(200, {
        message: "Seed is requried >= 200 characters.",
    }),
    src: z.string().min(1, {
        message: "Image is requried.",
    }),
    categoryId: z.string().min(1, {
        message: "CategoryId is requried.",
    }),
})


export const CharacterForm = ({ categories, initialData }: CharacterFormProps) => {
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className='col-span-2 md:col-span-1'>
                                    ...
                                    <FormDescription>
                                        Briefly describe your AI character.
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
